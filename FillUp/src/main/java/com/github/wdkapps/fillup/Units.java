...
public class Units implements Serializable {
    ...
    public String getLiquidVolumeLabel() {
        ...
        switch (value) {
            case MILES_PER_GALLON:
                id = R.string.gallons_label;
                break;
            case KILOMETERS_PER_LITER:
                id = R.string.liters_label;
                break;
    ...
    public String getLiquidVolumeRatioLabel() {
        ...
        switch (value) {
            case MILES_PER_GALLON:
                id = R.string.per_gallon_label;
                break;
            case KILOMETERS_PER_LITER:
                id = R.string.per_liter_label;
                break;
            case LITERS_PER_100_KILOMETERS:
                id = R.string.per_liter_label;
                break;
    ...
    public String getDistanceRatioLabel() {
        ...
        switch (value) {
            case MILES_PER_GALLON:
                id = R.string.per_mile_label;
                break;
            case KILOMETERS_PER_LITER:
                id = R.string.per_kilometer_label;
                break;
            case LITERS_PER_100_KILOMETERS:
                id = R.string.per_kilometer_label;
                break;
    ...
    public String getDistanceLabel() {
        ...
        switch (value) {
            case MILES_PER_GALLON:
                id = R.string.miles_label;
                break;
            case KILOMETERS_PER_LITER:
                id = R.string.kilometers_label;
                break;
            case LITERS_PER_100_KILOMETERS:
                id = R.string.kilometers_label;
                break;
    ...
    public String getMileageLabel() {
        ...
        switch (value) {
            case MILES_PER_GALLON:
                id = R.string.mpg_label;
                break;
            case KILOMETERS_PER_LITER:
                id = R.string.km_per_liter_label;
                break;
            case LITERS_PER_100_KILOMETERS:
                id = R.string.liters_per_100km_label;
                break;
            case UK_MPG_MILES_LITERS:
                id = R.string.mpg_label;
                break;
