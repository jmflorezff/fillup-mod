...
public class PlotDateRangeButtons implements OnCheckedChangeListener {
    ...
    private Integer getRangeValueForButton(CompoundButton button) {
        switch (button.getId()) {
            case R.id.button1:
                return PlotDateRange.PAST_MONTH;
            case R.id.button6:
                return PlotDateRange.PAST_6_MONTHS;
            case R.id.button12:
                return PlotDateRange.PAST_12_MONTHS;
            case R.id.buttonYTD:
                return PlotDateRange.YEAR_TO_DATE;
            case R.id.buttonAll:
                return PlotDateRange.ALL;
        }
        return null;
    }
